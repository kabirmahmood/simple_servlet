def VERSION_TAG=15
def SWARM_MASTER_NODE="54.229.135.125"
...
node {
        ...
        sh "${mvnHome}/bin/mvn sonar:sonar -Dsonar.host.url=http://192.168.56.101:9000 -Dsonar.jdbc.url="jdbc:h2:tcp://192.168.56.101/sonar""
